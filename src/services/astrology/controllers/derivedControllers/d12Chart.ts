...
// //   if (cached) {
// //     console.log('Returning D12 chart from Redis cache.');
// //     return JSON.parse(cached);
// //   }

// //   const fullUrl = `${ASTRO_ENGINE_URL}${apiEndpoint}`;
// //   const response = await axios.post(fullUrl, payload, { timeout: 10000 });
// //   console.log('DerivedData for D-12:', JSON.stringify(response.data, null, 2));
...
// //   const chartData = {
// //     ascendant: derivedData.d12_ascendant || derivedData.ascendant || {},
...
// //   const ascendantSign = derivedData.d12_ascendant?.sign || derivedData.ascendant?.sign || '';
// //   const metadata = {
...
// //           ascendant_degree: parseDMSToDecimal(derivedData.d12_ascendant?.degrees || derivedData.ascendant?.degrees),
// //           ascendant_degree_formatted: derivedData.d12_ascendant?.degrees || derivedData.ascendant?.degrees || null,
...
// // export const insertD12Chart = async (req: Request, res: Response): Promise<void> => {
// //   try {
// //     const { id } = req.params;
...
// //     const chartType = await ChartType.findOne({ where: { chart_code: 'D-12' } });
// //     if (!chartType) throw new Error('Chart type D-12 not found');
// //     const apiEndpoint = chartType.getDataValue('api_endpoint');
// //     if (!apiEndpoint) throw new Error('API endpoint not configured for D-12');

// //     const existingChart = await DerivedChart.findOne({
// //       where: { user_id: user.user_id, chart_type_id: chartType.chart_type_id },
// //     });
// //     if (existingChart) {
// //       res.status(400).json({ message: 'D-12 chart already exists for user' });
// //       return;
// //     }

// //     const cacheKey = `d12chart:${user.user_id}`;
...
// //     res.status(200).json({
// //       message: 'D12 chart inserted successfully',
// //       data: { derived_chart_id: derivedChartId, chart_type: 'D-12', data: derivedData },
// //     });
// //   } catch (error) {
// //     handleError(res, error, 'Failed to insert D-12 chart');
// //   }
// // };

// // export const fetchD12Chart = async (req: Request, res: Response): Promise<void> => {
// //   try {
// //     const { id } = req.params;
// //     const {
// //       date_of_birth,
...
// //     const redisKey = `d12_chart_user_${updatedUser.user_id}`;
// //     const cacheKey = `d12chart:${updatedUser.user_id}`;
...
// //     ) {
// //       console.log(`Serving D-12 chart for userId ${updatedUser.user_id} from Redis cache`);
// //       res.status(200).json({
// //         message: 'D12 chart fetched successfully from cache',
...
// //     let message = 'D12 chart fetched successfully';
...
// //       message = 'D12 chart created and fetched successfully';
// //     } else {
// //       const derivedData = await callAstroApi(apiEndpoint, buildApiPayload(updatedUser), cacheKey);
// //       const derivedChartId = await saveOrUpdateChartData(derivedData, chartType, updatedUser, apiEndpoint, existingChart);
// //       existingChart = await DerivedChart.findOne({ where: { derived_chart_id: derivedChartId } });
// //       message = 'D12 chart updated and fetched successfully';
// //     }

// //     if (!existingChart) throw new Error('Failed to retrieve D-12 chart');
...
// //     });
// //   } catch (error) {
// //     handleError(res, error, 'Failed to fetch D-12 chart');
// //   }
// // };
// import { Request, Response } from 'express';
// import axios from 'axios';
...
// export const updateD12Chart = async (
//   user: User,
//   chartType: any,
//   apiEndpoint: string,
//   existingChart: any
...
//     res.status(200).json({
//       message: 'D12 chart inserted successfully',
//       data: { derived_chart_id: derivedChartId, chart_type: 'D-12', derivedData },
//     });
//   } catch (error) {
//     handleError(res, error, 'Failed to insert D-12 chart');
//   }
...
//       const derivedChartId = await updateD12Chart(updatedUser, chartType, apiEndpoint, existingChart);
//       existingChart = await DerivedChart.findOne({ where: { derived_chart_id: derivedChartId } });
//       message = 'D12 chart updated and fetched successfully';
//     }
