...
// //   if (cached) {
// //     console.log('Returning D10 chart from Redis cache.');
// //     return JSON.parse(cached);
// //   }

// //   const fullUrl = `${ASTRO_ENGINE_URL}${apiEndpoint}`;
// //   const response = await axios.post(fullUrl, payload, { timeout: 10000 });
// //   console.log('DerivedData for D-10:', JSON.stringify(response.data, null, 2));
...
// //   const chartData = {
// //     ascendant: derivedData.d10_ascendant || derivedData.ascendant || {},
...
// //   const ascendantSign = derivedData.d10_ascendant?.sign || derivedData.ascendant?.sign || '';
// //   const metadata = {
...
// //     d1_ascendant_longitude: derivedData.notes?.d1_ascendant_longitude || derivedData.metadata?.d1_ascendant_longitude || null,
// //   };
...
// //           ascendant_degree: parseDMSToDecimal(derivedData.d10_ascendant?.degrees || derivedData.ascendant?.degrees),
// //           ascendant_degree_formatted: derivedData.d10_ascendant?.degrees || derivedData.ascendant?.degrees || null,
...
// // export const insertD10Chart = async (req: Request, res: Response): Promise<void> => {
// //   try {
// //     const { id } = req.params;
...
// //     const chartType = await ChartType.findOne({ where: { chart_code: 'D-10' } });
// //     if (!chartType) throw new Error('Chart type D-10 not found');
// //     const apiEndpoint = chartType.getDataValue('api_endpoint');
// //     if (!apiEndpoint) throw new Error('API endpoint not configured for D-10');

// //     const existingChart = await DerivedChart.findOne({
// //       where: { user_id: user.user_id, chart_type_id: chartType.chart_type_id },
// //     });
// //     if (existingChart) {
// //       res.status(400).json({ message: 'D-10 chart already exists for user' });
// //       return;
// //     }

// //     const cacheKey = `d10chart:${user.user_id}`;
...
// //     res.status(200).json({
// //       message: 'D10 chart inserted successfully',
// //       data: { derived_chart_id: derivedChartId, chart_type: 'D-10', data: derivedData },
// //     });
// //   } catch (error) {
// //     handleError(res, error, 'Failed to insert D-10 chart');
// //   }
// // };

// // export const fetchD10Chart = async (req: Request, res: Response): Promise<void> => {
// //   try {
// //     const { id } = req.params;
// //     const {
// //       date_of_birth,
...
// //     const redisKey = `d10_chart_user_${updatedUser.user_id}`;
// //     const cacheKey = `d10chart:${updatedUser.user_id}`;
...
// //     ) {
// //       console.log(`Serving D-10 chart for userId ${updatedUser.user_id} from Redis cache`);
// //       res.status(200).json({
// //         message: 'D10 chart fetched successfully from cache',
...
// //     let message = 'D10 chart fetched successfully';
...
// //       message = 'D10 chart created and fetched successfully';
// //     } else {
// //       const derivedData = await callAstroApi(apiEndpoint, buildApiPayload(updatedUser), cacheKey);
// //       const derivedChartId = await saveOrUpdateChartData(derivedData, chartType, updatedUser, apiEndpoint, existingChart);
// //       existingChart = await DerivedChart.findOne({ where: { derived_chart_id: derivedChartId } });
// //       message = 'D10 chart updated and fetched successfully';
// //     }

// //     if (!existingChart) throw new Error('Failed to retrieve D-10 chart');
...
// //     });
// //   } catch (error) {
// //     handleError(res, error, 'Failed to fetch D-10 chart');
// //   }
// // };
...
// export const updateD10Chart = async (
//   user: User,
//   chartType: any,
//   apiEndpoint: string,
//   existingChart: any
...
//       const derivedChartId = await updateD10Chart(updatedUser, chartType, apiEndpoint, existingChart);
//       existingChart = await DerivedChart.findOne({ where: { derived_chart_id: derivedChartId } });
//       message = 'D10 chart updated and fetched successfully';
//     }
